                                            ...
                                            <select class="user-select-auto form-control" name="customerTypes">
                                                <c:forEach items="${typesList}" var="types">
                                                    <option value="${types.getId()}"
                                                            <c:if test='${types.getId() eq requestScope["customers"].getType().getId()}'>selected</c:if> > ${types.getName()} </option>
                                                </c:forEach>
                                            </select>
                                        </div>
                                        <div class="col-sm-6">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-6">
                                            ...
                                            <select class="user-select-auto form-control" name="available">
                                                <option value="1"
                                                        <c:if test='${requestScope["customers"].isStatus() eq "1"}'>selected</c:if> >
                                                    Not Available
                                                </option>
                                                <option value="0"
                                                        <c:if test='${requestScope["customers"].isStatus() eq "0"}'>selected</c:if> >
                                                    Available
                                                </option>
                                            </select>
                                        </div>
