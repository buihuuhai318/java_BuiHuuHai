...
public class CustomerRepository implements ICustomerRepository {
    private static final String INSERT = "insert into customers (customer_name, customer_gender, customer_birthday, customer_phone, customer_email, customer_address, customer_image, customer_type_id, account_id) values (?, ?, ?, ?, ?, ?, ?, ?, ?);";
    ...
    public void insertCustomer(Customers customers) {
        ...
        try {
            ...
            preparedStatement.setInt(8, customers.getType());
    ...
    public Map<Integer, Customers> selectAllCustomer() {
        ...
        try {
            ...
            while (resultSet.next()) {
                ...
                customersMap.put(id, new Customers(id, name, gender, birthday, phone, address, status, image, type, accountRepository.selectAccount(accountId)));
            }
        } catch (SQLException e) {
            throw new RuntimeException(e);
        }
    ...
    public Map<String, Customers> selectAllCustomerByEmail() {
        ...
        try {
            ...
            while (resultSet.next()) {
                ...
                customersMap.put(accounts.getEmail(), new Customers(id, name, gender, birthday, phone, address, status, image, type, accounts));
            }
        } catch (SQLException e) {
            throw new RuntimeException(e);
        }
